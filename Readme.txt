...
Ce dépôt GitHub : https://github.com/leonelmaken/TP-4067-GROUPE-10  ,contient des exemples pratiques de l'utilisation du patron de conception État pour gérer les états de deux types d'objets : un ordinateur et une lampe. Le patron de conception État est utilisé pour permettre à un objet de changer son comportement lorsque son état interne change.
...
Pour exécuter les exemples, assurez-vous d'avoir Java installé sur votre système. Clonez ce dépôt : https://github.com/leonelmaken/TP-4067-GROUPE-10, et exécutez les fichiers Main.java correspondants à chaque exemple dans un éditeur.
